...
mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/bharatmart')
    ...
    await ManufacturerCategory_1.default.deleteMany({});
    ...
    for (const category of categories) {
        try {
            ...
            const mainCategory = new ManufacturerCategory_1.default({
                name: category.name,
                level: 0,
                parent: null
            });
            ...
            for (const subcategoryName of category.subcategories) {
                const subcategory = new ManufacturerCategory_1.default({
                ...
                await ManufacturerCategory_1.default.findByIdAndUpdate(mainCategory._id, {
